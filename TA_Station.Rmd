...
```{r}
library("readxl")
trend_analysis <- read_excel("D:\\OVGU\\Courses\\DSWR\\Project\\FinalModifiedData.xlsx")
...
```{r}
plot(TS_Amli)
lines(lowess(time(TS_Amli),TS_Amli), col='blue', lwd=2)
...
mk.test(TS_Olp, continuity = TRUE)
